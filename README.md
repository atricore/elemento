...
Finally your template class needs to implement `IsElement<E extends HTMLElement>`. The generated code implements the method `E element()` and returns the selected root element of your HTML template. 
